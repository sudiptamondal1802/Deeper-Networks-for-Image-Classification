...
plt.savefig(SAVE_PATH + 'Cifar10_VGG19_model2_cm.png')
plt.show()
plt.close()
...
my_file = open(os.path.join(PICKLE_DUMP,'cifar10_vgg19_model2'), 'wb') 
my_file = pickle.dump(cifar10_vgg19_model2, my_file)
