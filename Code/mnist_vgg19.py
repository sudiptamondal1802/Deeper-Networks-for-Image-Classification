...
for i in range(10):
  ...
  plt.yticks([])
#save the images
plt.savefig(SAVE_PATH + 'MNIST_VGG19_images.png')
plt.close()
...
plt.ylabel('Loss')
plt.legend()
plt.savefig(SAVE_PATH + 'MNIST_VGG19_loss_plot.png')
plt.close()
...
plt.ylabel('Accuracy')
plt.legend()
plt.savefig(SAVE_PATH + 'MNIST_VGG19_accuracy_plot.png')
plt.close()

"""# Test the trained network"""
print("Test results for MNIST VGG19")
...
plt.savefig(SAVE_PATH + 'MNIST_VGG19_sample_test_results.png')
plt.close()
...
my_file = open(os.path.join(PICKLE_DUMP,'mnist_vgg19_model1'), 'wb') 
my_file = pickle.dump(mnist_vgg19_model1, my_file)
