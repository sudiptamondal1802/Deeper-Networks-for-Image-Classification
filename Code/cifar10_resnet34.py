...
# save the images
plt.savefig(SAVE_PATH + 'Cifar10_Resnet34_images.png')
plt.close()
...
plt.ylabel('Loss')
plt.legend()
plt.savefig(SAVE_PATH + 'Cifar10_Resnet34_loss_plot.png')
plt.close()
...
plt.ylabel('Accuracy')
plt.legend()
plt.savefig(SAVE_PATH + 'Cifar10_Resnet34_accuracy_plot.png')
plt.close()

"""# Test the trained network"""
print("Test results for Cifar10 Resnet34")
# track test loss
test_loss = 0.0
...
plt.savefig(SAVE_PATH + 'Cifar10_Resnet34_model2_cm.png')
plt.show()
plt.close()
...
plt.savefig(SAVE_PATH + 'Cifar10_Resnet34_sample_test_results.png')
plt.close()
...
my_file = open(os.path.join(PICKLE_DUMP,'cifar10_resnet34_model2'), 'wb') 
my_file = pickle.dump(cifar10_resnet34_model2, my_file)
